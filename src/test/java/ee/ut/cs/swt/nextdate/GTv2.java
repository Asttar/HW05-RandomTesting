...
public class GTv2 {
	...
	public void testCreatesNextDate1() throws Throwable {
	    ...
	    String string0 = nextDate0.run(10, 30, 1824);
	    assertEquals("10/31/1824", string0);
	}
	...
	public void testCreatesNextDate14() throws Throwable {
	    ...
	    String string0 = nextDate0.run(3, 31, 1981);
	    assertEquals("4/1/1981", string0);
	}
	...
	public void testCreatesNextDate16() throws Throwable {
	    ...
	    String string0 = nextDate0.run(8, 21, 1824);
	    assertEquals("8/22/1824", string0);
	}
	...
	public void testRunWithPositive0() throws Throwable {
	    NextDate nextDate0 = new NextDate(2021, 2021, 2021);
	    String string0 = nextDate0.run(2021, 31, 12);
	    assertEquals("invalid Input Date", string0);
	}
